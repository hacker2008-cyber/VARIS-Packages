...
-DLFS_FOUND=ON
-DICONV_INCLUDE_DIR=$TERMUX_PREFIX/include
-DICONV_LIBRARIES=$TERMUX_PREFIX/lib/libiconv.so
-DICONV_SYMBOL_FOUND=ON
-DXXHASH_INCLUDE_DIR=$TERMUX_PREFIX/include
-DXXHASH_LIBRARY=$TERMUX_PREFIX/lib/libxxhash.so
-DXXHASH_FOUND=ON
-DZSTD_INCLUDE_DIR=$TERMUX_PREFIX/include
-DZSTD_LIBRARY=$TERMUX_PREFIX/lib/libzstd.so
-DZSTD_FOUND=ON
-DLZMA_INCLUDE_DIR=$TERMUX_PREFIX/include
-DLZMA_LIBRARY=$TERMUX_PREFIX/lib/liblzma.so
-DLZMA_FOUND=ON
-DBZ2_INCLUDE_DIR=$TERMUX_PREFIX/include
-DBZ2_LIBRARY=$TERMUX_PREFIX/lib/libbz2.so
-DBZ2_FOUND=ON
"
